...
VALIDATORS = [
    ...
    "validate_delivery_adapters.py",
    "validate_content_graph.py",
    "validate_reuse_value_scoring.py",
    "validate_evidence_refs.py",
    "validate_comment_pipeline.py",
    "validate_scene02_patrol.py",
    "validate_weekly_baseline.py",
    "validate_scene_handoff_exports.py",
    "validate_scene_ops.py",
    "validate_platform_p0.py",
    "validate_platform_integrations.py",
...
EXTRA_COMPILE_ONLY = [
    ...
    "deliver_operator_run.py",
    "content_graph.py",
    "reuse_value_scoring.py",
    "evidence_refs.py",
    "scene_evidence_refs.py",
    "comment_pipeline.py",
    ...
    "run_scene1819.py",
    "weekly_baseline.py",
    "category_saturation.py",
    "pack_video_text.py",
    "production_spec_handoff.py",
    "scene01_collection_board.py",
    "scene03_creation_matrix.py",
    "feishu_delivery_adapter.py",
    "project_space.py",
    "generation_jobs.py",
    "asset_library.py",
    "clipcat_client.py",
    "tiktok_shop_source.py",
    "generation_renderer_backend.py",
    "sync_tiktok_shop_capture.py",
